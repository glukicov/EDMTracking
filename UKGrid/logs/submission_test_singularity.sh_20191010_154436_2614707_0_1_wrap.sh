...
#
umask 002
# /fife/local/scratch/uploads/gm2/gm2pro/2019-10-10_154435.038202_9229/submission_test_singularity.sh_20191010_154436_2614707_0_1_wrap.sh
# Automatically generated by: 
#          jobsub -l +JobsubClientDN="/DC=org/DC=incommon/C=US/ST=IL/L=Batavia/O=Fermi Research Alliance/OU=Fermilab/CN=gm2pro-gm2gpvm01.fnal.gov" -l +JobsubClientIpAddress="131.225.67.75" -l +Owner="gm2pro" -l +JobsubServerVersion="1.3.0.1.rc13" -l +JobsubClientVersion="1.2.10" -l +JobsubClientKerberosPrincipal="glukicov@FNAL.GOV" --email-to=glukicov@fnal.gov -M --memory=1000MB --expected-lifetime=30m --disk=1GB --resource-provides=usage_model=OFFSITE --site=Liverpool -l +SingularityImage="/cvmfs/singularity.opensciencegrid.org/fermilab/fnal-wn-sl6:latest" /fife/local/scratch/uploads/gm2/gm2pro/2019-10-10_154435.038202_9229/submission_test_singularity.sh 
...
export JOBSUB_EXE_SCRIPT=$(ls submission_test_singularity.sh 2>/dev/null)
if [ "$JOBSUB_EXE_SCRIPT" = "" ]; then 
     export JOBSUB_EXE_SCRIPT=$(find . -name submission_test_singularity.sh -print | head -1)
fi
chmod +x $JOBSUB_EXE_SCRIPT
${JSB_TMP}/ifdh.sh log "gm2pro:$JOBSUBJOBID BEGIN EXECUTION $JOBSUB_EXE_SCRIPT   
 "
...
>&2 echo `date` $JOBSUBJOBID BEGIN EXECUTION $JOBSUB_EXE_SCRIPT   
$JOBSUB_EXE_SCRIPT   
JOB_RET_STATUS=$?
...
${JSB_TMP}/ifdh.sh log "$JOBSUBJOBID gm2pro:submission_test_singularity.sh COMPLETED with return code $JOB_RET_STATUS" 
exit $JOB_RET_STATUS
