...
\begin{figure}[htpb]
    \centering
    \subfloat[]{\includegraphics[width=0.82\linewidth]{count_60h_S12.png}\label{fig:s12_bz_1}} \\ 
    \subfloat[]{\includegraphics[width=0.82\linewidth]{bz_60h_S12.png}\label{fig:s12_bz_2}} 
    \vspace{-0.2cm}
...
\begin{figure}[htpb]
    \centering
    \subfloat[]{\hspace{-0.2cm}\includegraphics[width=0.95\linewidth]{s12S18_sum_bz.png}\label{fig:bz_1}} \\  
    \subfloat[]{\hspace{-1cm}\includegraphics[width=0.9\linewidth]{sum_bz.png}\label{fig:bz_2}} 
    \vspace{-0.2cm}
    \caption{Fitting results in all \R1 datasets: a) S12 and S18 separately, and b) mean of the two stations. The plotted fit parameter $A_{\mathrm{B_z}}$ was extracted from~\cref{fig:s12_bz} for all datasets. The individual fit results are summarised in DocDB:22201~\cite{Gleb_docdb}.}
    \label{fig:bz}
\end{figure}
...
\begin{figure}[htpb]
    \centering
    \subfloat[]{\includegraphics[width=\linewidth]{ppm_bz.png}\label{fig:felina_1}} \\
    \subfloat[]{\includegraphics[width=0.95\linewidth]{ppm_omega.png}\label{fig:felina_2}} 
    \vspace{-0.2cm}
