...
# arg_parser.add_argument("--hist_path", type=str, default="AllStationsNoTQ/VertexExt/t>0/0<p<3600/radialPos") 
...
if (args.hist):
    ...
    if(args.beam):
        ...
        # ax.set_xlabel("Radial beam position [mm]", fontsize=18)
        # cu.textL(ax, 1.32, 1.15, "Radial [mm]:"+"\n"+str(legendX), fs=15)
        # N=cu.sci_notation(len(x)) # format as a 
        # cu.textL(ax, 1.32, 0.00, "N: "+N, fs=15)
        # plt.savefig("../fig/beamX.png", dpi=300)
