...
Blinders* Blinders_edm_blinded(blinding::Blinders::fitType fit_type, char* blindingString, double boxWidth, double gaussWidth)     { return new Blinders(fit_type, blindingString, boxWidth, gaussWidth); }
