...
# # TODO 
# from root_numpy import hist2array # delete after testing
# from ROOT import TH1, TH2, TFile # delete after testing


# data, n_bins, dBins = ru.root2np(file_path="DATA/largeEDM_sample.root", hist_path="AllStations/TrackFit/t>30/700<p<2400/pValue")
...
# Example of getting 1D histo from data 
...
# data, n_bins, dBins = ru.root2np(file_path="DATA/largeEDM_sample.root", hist_path="AllStationsNoTQ/VertexExtap/t>30/700<p<2400/h_verticalPos")
data, n_bins, dBins = ru.root2np(file_path="DATA/test.root", hist_path="h_verticalPos")
